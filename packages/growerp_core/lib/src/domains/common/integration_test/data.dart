...
List<User> leads = [
  User(
    ...
    company: Company(name: 'Lead company 1', role: Role.lead),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    company: Company(name: 'Lead company 2', role: Role.lead),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    company: Company(name: 'Lead company 3', role: Role.lead),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    company: Company(name: 'Lead company 4', role: Role.lead),
    telephoneNr: '9999999999',
  ),
  User(
    firstName: 'lead5',
    lastName: 'last Name 5',
    company: Company(name: 'Lead company 5', role: Role.lead),
  ...
  User(
    ...
    company: Company(name: 'Lead company 6', role: Role.lead),
    email: 'emailXXX@example.org',
