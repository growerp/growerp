...
List<User> leads = [
  User(
    ...
    company: Company(name: 'Lead company 0'),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    userGroup: UserGroup.lead,
    company: Company(name: 'Lead company 1'),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    userGroup: UserGroup.lead,
    company: Company(name: 'Lead company 2'),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    userGroup: UserGroup.lead,
    company: Company(name: 'Lead company 3'),
    email: 'emailXXX@example.org',
    telephoneNr: '9999999999',
  ),
  User(
    ...
    userGroup: UserGroup.lead,
    company: Company(name: 'Lead company 4'),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    userGroup: UserGroup.lead,
    company: Company(name: 'Lead company 5'),
    email: 'emailXXX@example.org',
...
List<User> suppliers = [
  ...
  User(
    ...
    lastName: 'last Name2',
    userGroup: UserGroup.supplier,
    company: Company(name: 'supplier company 4'),
    email: 'emailXXX@example.org',
  ...
  User(
    ...
    lastName: 'last Name4',
    userGroup: UserGroup.supplier,
    company: Company(name: 'supplier company 5'),
    email: 'emailXXX@example.org',
