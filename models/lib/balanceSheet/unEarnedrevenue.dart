...
class UnEarnedRevenue {
  ...
  factory UnEarnedRevenue.fromJson(Map<String, dynamic> json) {
    return UnEarnedRevenue(
      ...
      balanceByTimePeriod: json['balanceByTimePeriod'] == null
          ? null
          : BalanceByTimePeriod.fromJson(
              json['balanceByTimePeriod'] as Map<String, dynamic>),
      totalBalanceByTimePeriod: json['totalBalanceByTimePeriod'] == null
          ? null
          : TotalBalanceByTimePeriod.fromJson(
              json['totalBalanceByTimePeriod'] as Map<String, dynamic>),
      totalPostedByTimePeriod: json['totalPostedByTimePeriod'] == null
          ? null
          : TotalPostedByTimePeriod.fromJson(
              json['totalPostedByTimePeriod'] as Map<String, dynamic>),
      totalPostedNoClosingByTimePeriod:
          json['totalPostedNoClosingByTimePeriod'] == null
              ? null
              : TotalPostedNoClosingByTimePeriod.fromJson(
                  json['totalPostedNoClosingByTimePeriod']
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'totalPostedNoClosingByTimePeriod':
          totalPostedNoClosingByTimePeriod?.toJson(),
    };
  }
}
