...
// console.log("Parameter: " + PARAM_NAME + "=" + PARAM_VALUE);
...
describe('Admin website order process', function () {
  ...
  it('create order for product ' + productKey, async function () {
    ...
    if (currentTestData.orderId == null) {
      ...
      //await tapByKey(driver, "GrowERP demo movie");
      //await tapByKey(driver, "GrowERP training movie");
      await tapByKey(driver, productKey);
