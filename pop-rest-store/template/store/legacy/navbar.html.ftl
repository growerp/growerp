            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-shopping-bag mr-1"></i>${l('GrowerpWebsiteShop')} <i class="fas fa-chevron-down icon-down"></i>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <#list browseRootCategoryInfo.subCategoryList as category>
                            <a class="dropdown-item item-color" href="${up}/category/${category.productCategoryId}">
                ...
                <#if storeInfo.categoryByType.PsctPromotions.nbrOfProducts != 0>
                    <a class="nav-link" href="${up}/category/${storeInfo.categoryByType.PsctPromotions.productCategoryId}">
                ...
                <li class="nav-item dropdown">
                    ...
                    <#list topItem.items as item>
                        <a class="dropdown-item item-color" href="${up}/content/${topItem.path}#${item.anchor}">${item.text}</a>
                    </#list>
                    </div>
                </li>
                <#else>
                    ...
                    <#else>    
                        <a class="nav-link" href="${up}/content/${topItem.path}">
                    </#if>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link d-flex align-items-center" href="#" id="navbarLanguageLink"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                       aria-label="${l('GrowerpWebsiteLanguage')}">
                        <i class="fas fa-globe mr-1"></i>
                        <span class="text-uppercase">${(websiteLocale!'')?has_content?string(websiteLocale!'', 'en')}</span>
                        <i class="fas fa-chevron-down icon-down ml-1"></i>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarLanguageLink">
                        <#list pageAlternates![] as alt>
                            <#assign altLocale = (alt.locale == 'x-default')?then('en', alt.locale)>
                            <a class="dropdown-item item-color" hreflang="${altLocale}"
                               href="${alt.url}">${localeNames[altLocale]!altLocale}</a>
                        </#list>
                    </div>
                </li>
                </#if>
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                <li class="nav-item">
                    ...
                    <#else>
                        ...
                        <span class="d-none d-md-inline ml-1">${l('GrowerpWebsiteCart')}</span>
                    </a>
                </li>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="modal-title mb-0" id="emptyCartModalLabel">${l('GrowerpWebsiteCartEmpty')}</h5>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-continue" data-dismiss="modal">${l('GrowerpWebsiteContinueShopping')}</button>
            </div>
        </div>
    </div>
</div>
