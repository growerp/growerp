    ...
    <div class="row mt-4">
        ...
        <div class="customer-menu col-lg-3 col-md-4 mb-5">
            <h5 style="font-family: 'Outfit', sans-serif; font-weight: 600; color: var(--neutral-800); margin-bottom: 1rem;">
                <i class="fas fa-book-open mr-2" style="color: var(--primary-500);"></i>${l('GrowerpWebsiteNavigation')}
            </h5>
    ...
    <#if topMenu.title != 'obsidian'>
            <div class="menu-section mb-3">
                <span class="modal-text" style="font-size: 1.1rem;">
                    <a href="${up}/content/${topMenu.path}#${topMenu.anchor}" class="d-flex align-items-center">
                ...
                <#list topMenu.items as item>
                    <li>
                        <a href="${up}/content/${topMenu.path}#${item.anchor}" class="d-flex align-items-center">
...
<#macro showPage page>
    <li>
        <a href="${up}/content/${page.path}" class="d-flex align-items-center">
