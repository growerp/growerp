...
<footer class="border-t border-on-primary-container/10 bg-primary-container/80 mt-16">
    <div class="max-w-container mx-auto px-4 md:px-12 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="${TwitterUrl}" target="_blank" rel="noopener" aria-label="Twitter" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
                    ...
                    <a href="${FacebookUrl}" target="_blank" rel="noopener" aria-label="Facebook" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
                    ...
                    <a href="${InstagramUrl}" target="_blank" rel="noopener" aria-label="Instagram" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
                    ...
                    <a href="${YouTubeUrl}" target="_blank" rel="noopener" aria-label="YouTube" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
                    ...
                    <a href="${LinkedInUrl}" target="_blank" rel="noopener" aria-label="LinkedIn" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
                    ...
                    <a href="${SubstackUrl}" target="_blank" rel="noopener" aria-label="Substack" class="text-on-primary-container/70 hover:text-on-primary-container transition-colors">
            ...
            <!-- Quick Links -->
            <div>
                <h5 class="font-display font-semibold text-on-primary-container mb-4">${l('GrowerpWebsiteQuickLinks')}</h5>
                <ul class="grid grid-cols-2 gap-x-4 gap-y-2">
                    <li><a href="${up}/" class="font-label text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${l('GrowerpWebsiteHome')}</a></li>
                    <#if isMarketing>
                    <li><a href="${up}/modules" class="font-label text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${l('GrowerpWebsiteApps')}</a></li>
                    ...
                    <#if topItem.items?has_content>
                        ...
                        <#if item.path??>
                        <li><a href="${up}/content/${item.path}" class="font-label text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${item.title!item.path}</a></li>
                        </#if>
                        </#list>
                    <#else>
                    <li>
                        <#if topItem.path == 'obsidian'>
                        <a href="/${topItem.path}" class="font-label text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${topItem.title!topItem.path}</a>
                        <#else>
                        <a href="${up}/content/${topItem.path}" class="font-label text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${topItem.title!topItem.path}</a>
                        </#if>
                    </li>
                    </#if>
                    </#list>
            ...
            <!-- Contact Info -->
            <div>
                <h5 class="font-display font-semibold text-on-primary-container mb-4">${l('GrowerpWebsiteContactUs')}</h5>
                <ul class="space-y-3">
                    <#if companyPostalAddress?? && (companyPostalAddress.address1!'')?has_content>
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-on-primary-container/80 text-[20px] mt-0.5">location_on</span>
                        <span class="text-sm text-on-primary-container/70">
                    ...
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-on-primary-container/80 text-[20px]">call</span>
                        <span class="text-sm text-on-primary-container/70"><#if (companyPhone.countryCode!'')?has_content>+${companyPhone.countryCode} </#if><#if (companyPhone.areaCode!'')?has_content>${companyPhone.areaCode} </#if>${companyPhone.contactNumber}</span>
                    </li>
                    </#if>
                    <#if companyEmailMech?? && (companyEmailMech.infoString!'')?has_content>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-on-primary-container/80 text-[20px]">mail</span>
                        <a href="mailto:${companyEmailMech.infoString}" class="text-sm text-on-primary-container/70 hover:text-on-primary-container transition-colors">${companyEmailMech.infoString}</a>
                    </li>
                    </#if>
                </ul>
            </div>
        ...
        <!-- Bottom Bar -->
        <div class="pt-6 border-t border-on-primary-container/10 flex flex-col md:flex-row items-center justify-between gap-3">
            <p class="text-sm text-on-primary-container/60">
                &copy; ${.now?string('yyyy')} ${storeInfo.productStore.storeName!''}. All rights reserved.
            </p>
            <p class="text-sm text-on-primary-container/60 flex items-center gap-2">
                <a href="https://www.moqui.org" target="_blank" class="hover:text-on-primary-container transition-colors">Built with Moqui Framework</a>
                <span class="text-on-primary-container/50">|</span>
                <a href="https://www.growerp.com" target="_blank" class="hover:text-on-primary-container transition-colors">Powered by GrowERP</a>
            </p>
        </div>
    </div>
</footer>
