...
TableData getSubscriptionTableData(Bloc bloc, String classificationId,
  ...
  if (isPhone) {
    ...
    rowContent.add(TableRowContent(
        name: al.subscriber, width: isPhone ? 35 : 20, value: subscriber));
    rowContent.add(
  ...
  if (isPhone) {
    ...
    rowContent
        .add(TableRowContent(name: al.fromDate, width: 8, value: fromDate));

    rowContent
        .add(TableRowContent(name: al.thruDate, width: 8, value: thruDate));
  }
  if (!isPhone) {
    rowContent.add(TableRowContent(
