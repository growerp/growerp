...
TableData getTableData(Bloc bloc, String classificationId, BuildContext context,
  ...
  rowContent.add(TableRowContent(
      name: Text(al.prices, textAlign: TextAlign.right),
      width: isPhone ? 15 : 5,
      value: Text(
          item.price
  ...
  if (!isPhone) {
    rowContent.add(TableRowContent(
        name: Text(al.listPrice(al.currency), textAlign: TextAlign.right),
        width: isPhone ? 15 : 5,
        value: Text(
            item.listPrice
                .currency(currencyId: item.currency?.currencyId ?? currencyId),
  ...
  if (!isPhone && classificationId != 'AppHotel') {
    rowContent.add(TableRowContent(
        name: Text(al.category, textAlign: TextAlign.center),
        width: 15,
        value: Text(
