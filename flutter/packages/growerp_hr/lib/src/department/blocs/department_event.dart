...
class DepartmentsFetch extends DepartmentEvent {
...
class DepartmentDelete extends DepartmentEvent {
  const DepartmentDelete(this.department);
  final Department department;
}

class DepartmentSearchChanged extends DepartmentEvent {
  const DepartmentSearchChanged({required this.searchString});
  final String searchString;
  @override
