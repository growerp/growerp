...
In growerp/packages/workflow dir:  
...
4. create app bundle in workflow home:
...
flutter create --org org/growerp/workflow .
init: fastlane supply init

#### Upload in Play store: (android dir)
(everything including build/meta/screenshots)
fastlane supply \
    --aab /home/dell/workflow/build/app/outputs/bundle/release/app-release.aab \
