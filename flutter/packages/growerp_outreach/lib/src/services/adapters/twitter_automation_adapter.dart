...
/// Twitter/X automation adapter using browsermcp
///
/// This adapter uses the browsermcp MCP server to automate Twitter/X
/// profile searches, follows, and direct messages.
class TwitterAutomationAdapter
    with LoggerMixin
    implements PlatformAutomationAdapter {
