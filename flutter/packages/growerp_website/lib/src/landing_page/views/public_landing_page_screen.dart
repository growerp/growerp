...
class _PublicLandingPageScreenState extends State<PublicLandingPageScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(WebsiteLocalizations.of(context)!.assessmentLandingPage),
      ...
      body: BlocBuilder<LandingPageBloc, LandingPageState>(
        builder: (context, state) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(WebsiteLocalizations.of(context)!.retry),
                  ),
                ],
              ),
            );
          ...
          return Center(child: Text(WebsiteLocalizations.of(context)!.landingPageNotFound));
        },
      ),
    );
  }
