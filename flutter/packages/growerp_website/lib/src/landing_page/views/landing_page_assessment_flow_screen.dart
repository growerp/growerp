  ...
  void _onCtaPressed() {
    ...
    if (landingPageState.status == LandingPageStatus.success &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(WebsiteLocalizations.of(context)!.assessmentNotAvailableForThisLandingPage),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: Text(WebsiteLocalizations.of(context)!.backToLandingPage),
                    ),
                    ElevatedButton(
                      onPressed: () {
                      ...
                      child: Text(WebsiteLocalizations.of(context)!.viewDetailedResults),
                    ),
                  ],
                ),
              ],
