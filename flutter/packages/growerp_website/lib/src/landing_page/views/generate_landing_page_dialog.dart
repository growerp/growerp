...
import '../blocs/landing_page_generation_bloc.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Advanced Options
            ExpansionTile(
              title: Text(WebsiteLocalizations.of(context)!.advancedOptions),
              children: [
                Column(
                  children: [
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: _descriptionController.text.length >= 20
                      ...
                      : null,
                  child: Text(WebsiteLocalizations.of(context)!.generate),
                ),
              ],
            ),
          ],
