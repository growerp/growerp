...
import '../blocs/landing_page_bloc.dart';
import '../blocs/landing_page_event.dart';
import '../blocs/landing_page_state.dart';
import '../../assessment/blocs/assessment_bloc.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          hint: Text(WebsiteLocalizations.of(context)!.selectStatus),
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonFormField<String?>(
                          ...
                          hint: Text(WebsiteLocalizations.of(context)!.selectHookType),
                          ...
                          items: [
                            ...
                            DropdownMenuItem<String>(
                              value: 'frustration',
                              child: Text(WebsiteLocalizations.of(context)!.frustration),
                            ),
                            DropdownMenuItem<String>(
                              value: 'results',
                              child: Text(WebsiteLocalizations.of(context)!.results),
                            ),
                            DropdownMenuItem<String>(
                              value: 'custom',
                              child: Text(WebsiteLocalizations.of(context)!.custom),
                            ),
                          ].toList(),
                          onChanged: (String? newValue) {
                            setState(() {
                      ...
                      Expanded(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: [
                            DropdownMenuItem<String>(
                              value: 'Assessment',
                              child: Text(WebsiteLocalizations.of(context)!.assessment),
                            ),
                            DropdownMenuItem<String>(
                              value: 'Url',
                              child: Text(WebsiteLocalizations.of(context)!.url),
                            ),
                            DropdownMenuItem<String>(
                              value: 'Form',
                              child: Text(WebsiteLocalizations.of(context)!.form),
                            ),
                          ],
                          onChanged: (String? newValue) {
                            setState(() {
            ...
            child: OutlinedButton(
              ...
              onPressed: () async {
                final confirmed = await showDialog<bool>(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: Text(WebsiteLocalizations.of(context)!.deleteLandingPage),
                      content: const Text(
        ...
        children: [
          Expanded(
            child: OutlinedButton.icon(
              ...
              label: Text(WebsiteLocalizations.of(context)!.sections),
              onPressed: () async => await showDialog(
                barrierDismissible: true,
                context: context,
                builder: (BuildContext context) {
          ...
          Expanded(
            child: OutlinedButton.icon(
              ...
              label: Text(WebsiteLocalizations.of(context)!.credibility),
              onPressed: () async => await showDialog(
                barrierDismissible: true,
                context: context,
                builder: (BuildContext context) {
