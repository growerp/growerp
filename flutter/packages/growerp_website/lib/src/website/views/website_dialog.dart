  ...
  Widget _showForm(WebsiteState state) {
        ...
        textButtons.add(InputChip(
          ...
          onDeleted: () async {
            bool? result = await confirmDialog(
                context, _localizations.areYouSure, _localizations.websiteContentDelete);
            if (result == true) {
    ...
    state.website!.productCategories.asMap().forEach((index, category) {
      browseCatButtons.add(InputChip(
        ...
        onDeleted: () async {
          bool? result =
              await confirmDialog(context, _localizations.areYouSure, _localizations.remove);
          if (result == true) {
            setState(() {
                ...
                child: Row(children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(labelText: _localizations.websiteUrl),
                      validator: (value) {
                        if (value!.isEmpty) {
              ...
              return DropdownSearch<Product>.multiSelection(
                ...
                popupProps: PopupPropsMultiSelection.menu(
                  ...
                  searchFieldProps: TextFieldProps(
                    autofocus: true,
                    decoration: InputDecoration(labelText: _localizations.select),
