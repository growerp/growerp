            ...
            BlocBuilder<AssessmentBloc, AssessmentState>(
              builder: (context, state) {
                ...
                if (state.status == AssessmentStatus.failure) {
                  return Scaffold(
                    appBar: AppBar(title: Text(WebsiteLocalizations.of(context)!.assessmentStep2)),
                    body: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(WebsiteLocalizations.of(context)!.errorLoadingAssessment),
                          ...
                          ElevatedButton(
                            ...
                            child: Text(WebsiteLocalizations.of(context)!.goBack),
                          ),
                        ],
                      ),
                    ),
