...
// Marketing time-billing workflow:
...
const marketingTestMenuConfig = MenuConfiguration(
  menuConfigurationId: 'MARKETING_TEST',
  appId: 'marketing',
  name: 'Marketing Test Menu',
  menuItems: [
    MenuItem(
      itemKey: 'FL_MAIN',
      title: 'Main',
...
GoRouter createMarketingTestRouter() {
  return createStaticAppRouter(
    menuConfig: marketingTestMenuConfig,
    appTitle: 'GrowERP Marketing Test',
    dashboard: const Center(child: Text('Marketing test dashboard')),
    widgetBuilder: (route) => switch (route) {
      ...
      _ => const Center(child: Text('Marketing test dashboard')),
    },
  );
}
...
void main() {
  ...
  testWidgets('''Marketing time billing workflow''', (tester) async {
    const taskName = 'Website maintenance';
    RestClient restClient = RestClient(await buildDioClient());
    await CommonTest.startTestApp(
      tester,
      createMarketingTestRouter(),
      marketingTestMenuConfig,
      const [
      ...
      blocProviders: [
        ...getUserCompanyBlocProviders(restClient, 'AppMarketing'),
        ...getOrderAccountingBlocProviders(restClient, 'AppMarketing'),
      ],
      title: "Marketing billing test",
      clear: true,
    );
