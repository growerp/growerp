...
/// with the agent fleet counters in a row at the bottom. The tile route
/// must be listed in DashboardGrid.compactGraphicRoutes so the icon+title
/// render beside it.
class AgentControlDashboardChartMini extends StatefulWidget {
  const AgentControlDashboardChartMini({super.key});

  @override
  State<AgentControlDashboardChartMini> createState() =>
      _AgentControlDashboardChartMiniState();
}

class _AgentControlDashboardChartMiniState
    extends State<AgentControlDashboardChartMini> {
  AgentControlDashboard? dashboard;
  String? error;
  ...
  Widget _funnel(
    ...
    List<AgentControlStageSummaryItem> summary,
  ) {
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      '${item.count}',
                      key: Key('agentControlStage${item.stageId}'),
                      style: labelStyle,
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        key: const Key('agentControlDashboardMini'),
        children: [
