...
/// Accounting dashboard content - displays accounting menu options as cards
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MenuConfigBloc, MenuConfigState>(
      builder: (context, state) {
        ...
        // Get dashboard items: accounting sub-options (ADMIN_ACC_*)
            ...
            menuConfig.menuOptions
                .where(
                  (option) =>
                      ...
                      option.menuOptionId!.startsWith('ADMIN_ACC_'),
                )
                .toList()
