          ...
          children: <Widget>[
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  _text(
                    'Moqui is a relatively new framework which started being '
            ...
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  _text(
                    'Moqui\'s features are very extensive but were initially '
            ...
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  _text(
                    'Before you want to run the system locally, you need to '
            ...
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  _text(
                    'There are several google discussion groups about Moqui, '
                    'also the git updates are logged there:\n\n',
                  ),
                  _textLink(
                    'https://demo.moqui.org/store',
                    'Google groups: Moqui Applications\n',
                  ),
                  _textLink(
                    'https://groups.google.com/forum/#!forum/moqui',
