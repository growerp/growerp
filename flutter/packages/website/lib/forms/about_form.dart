          ...
          children: <Widget>[
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  _text(
                    'GrowERP is a Flutter frontend for either Moqui '
                  ...
                  _textLink(
                    'https://www.github.com/growerp/growerp',
                    'single repository',
                  ),
                  _text(' in several branches.\n\n'),
                  _text('The Moqui backend component can be found '),
                  _textLink(
                    'https://www.github.com/growerp/growerp-moqui',
                    'here.\n',
                  ),
                  _text('The Ofbiz component can be found '),
                  _textLink(
                    'https://www.github.com/growerp/growerp-ofbiz',
                    'here.\n',
                  ),
                  _text(
            ...
            Bloc(
              ...
              content: TextSpan(
                children: <TextSpan>[
                  ...
                  _text(
                    'via categories/products create order and send to '
                    'related company\n\n',
                  ),
                  _text('4. restaurant\n'),
