            ...
            return Column(
              children: [
                ...
                if (state.ledgerReport?.csvRows == null ||
                    (minY == 0.0 && maxY == 0.0))
                  Text(
                    "${_localizations.noDataForPeriod}${state.ledgerReport?.period!.periodName.substring(1, 5)}",
                              ...
                              for (
                                ...
                                HorizontalLine(
                                  ...
                                  label: HorizontalLineLabel(
                                    style: TextStyle(color: getColor(title)),
                                    show: true,
                                    labelResolver: (p0) =>
                                        state.ledgerReport!.csvRows![0][title +
                                            1],
                                  ),
                                ),
                            ],
