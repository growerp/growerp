...
/// beside it.
class AcctPurchaseDashboardChartMini extends StatefulWidget {
  const AcctPurchaseDashboardChartMini({super.key});

  @override
  State<AcctPurchaseDashboardChartMini> createState() =>
      _AcctPurchaseDashboardChartMiniState();
}

class _AcctPurchaseDashboardChartMiniState
    extends State<AcctPurchaseDashboardChartMini> {
  AcctPurchaseDashboard? dashboard;
  String? error;
  ...
  Widget _funnel(
    ...
    List<AcctPurchaseStageSummaryItem> summary,
  ) {
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      '${item.count}',
                      key: Key('acctPurchaseStage${item.stageId}'),
                      style: labelStyle,
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        key: const Key('acctPurchaseDashboardMini'),
        children: [
