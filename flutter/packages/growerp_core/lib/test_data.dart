...
List<Company> companies = [
  Company(
    name: 'companyName0',
    currency: Currency(description: 'Baht'),
  ),
  Company(
    name: 'companyName1',
    currency: Currency(description: 'Euro'),
  ),
  Company(
    name: 'companyName2',
    currency: Currency(description: 'Dollar'),
  ),
  Company(
    name: 'companyName3',
    currency: Currency(description: 'Euro'),
...
List<Company> leadCompanies = [
  ...
  Company(name: 'Lead company 4', role: Role.lead, telephoneNr: '9999999999'),
  Company(name: 'Lead company 5', role: Role.lead, telephoneNr: '000000000000'),
  Company(
    name: 'Lead company 6',
    role: Role.lead,
    email: 'emailXXX@example.org',
...
List<Company> customerCompanies = [
  Company(name: 'customer company1', role: Role.customer),
  Company(
...
List<GlAccount> glAccounts = [
  ...
  GlAccount(
    ...
    accountClass: const AccountClass(description: "Loans Receivable"),
  ),
  // 2 liability
  GlAccount(
    accountCode: "200",
    accountName: "Notes Payable",
    accountClass: const AccountClass(description: "Liability"),
  ),
  GlAccount(
    accountCode: "210",
    accountName: "Notes Payable",
  ...
  GlAccount(
    ...
    accountClass: const AccountClass(description: "Cash"),
  ),
  GlAccount(
    accountCode: "230",
  ...
  GlAccount(
    ...
    accountClass: const AccountClass(description: "Expenses"),
  ),
  GlAccount(
    accountCode: "510",
    accountName: "Wages",
...
List<LedgerJournal> ledgerJournals = [
  LedgerJournal(journalName: "first journal"),
  LedgerJournal(journalName: "second journal"),
  LedgerJournal(journalName: "third journal"),
  LedgerJournal(journalName: "fourth journal"),
];
